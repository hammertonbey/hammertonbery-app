  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-[#8b6b61] hover:bg-[#5d4037] text-[#f8f5f0] transition-colors">
          Generate Design
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px] bg-[#f8f5f0]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <Label htmlFor="jewelry-type" className="text-[#5d4037]">
              Jewelry Type
            </Label>
            <RadioGroup
              id="jewelry-type"
          ...
          <div className="grid gap-2">
            <Label htmlFor="style" className="text-[#5d4037]">
              Style
            </Label>
            <RadioGroup
              id="style"
          ...
          <div className="grid gap-2">
            <Label htmlFor="prompt" className="text-[#5d4037]">
              Design Prompt
            </Label>
            <Textarea
              id="prompt"
        ...
        <Button
          ...
          className="bg-[#8b6b61] hover:bg-[#5d4037] text-[#f8f5f0] transition-colors w-full"
        >
          Generate Design
        </Button>
      </DialogContent>
